...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1648861366:AAHypiRRn4qIfsCAbR9mWd5KwSDtFu47Eiw")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 1858153))
    API_HASH = os.environ.get("API_HASH", 5fb9328cdf9a7aaad5fed030484d6022))
    OWNER_ID = int(os.environ.get("OWNER_ID", 1196519780))
